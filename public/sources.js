...
circlewarp:{label:'CircleWarp',history:'circlewarp'},
 archemist:{label:'Archemist'},'pools-trade':{label:'pools.trade'},noxa:{label:'Noxa'},argus:{label:'ArgusPad'},long:{label:'Long'},o1:{label:'o1'},dyor:{label:'DYOR'},onchain:{label:'On-chain',kind:'dex'},
