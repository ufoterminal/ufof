...
export const RPC_HTTP=(process.env.RPC_HTTP||'https://rpc.arc-scan.org,https://5042.rpc.thirdweb.com,https://arc-mainnet.infura.io/v3/b6bf7d3508c941499b10025c0776eaf8').split(',').map(x=>x.trim()).filter(Boolean);
