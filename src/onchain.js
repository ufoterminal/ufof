...
export async function recentTrades(token,limit=100,primaryPool=null){
 ...
 return rows.map(r=>({id:r.pool+':'+r.block+':'+r.log_index,pool:r.pool,block:Number(r.block),logIndex:Number(r.log_index),at:Number(r.at),price:Number(r.price),usd_volume:Number(r.usd_volume),
